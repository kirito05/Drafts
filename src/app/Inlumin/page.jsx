      ...
      <header className="flex flex-col ">
        ...
        <section className="h-[50vh] relative">
          ...
          <h1 className="text-5xl font-semibold italic text-slate-200 absolute bottom-10 left-5">
            Applications Of Inlumin in Inventory Management and Automation of Full Procure-to-pay process
          </h1>
        </section>
      </header>
      <br />
          ...
          <section id="question">
            ...
            <div className="text-2xl">
              <ul className="list-disc flex flex-col justify-between h-[32vh]">
                <li className="m-4">
                  While handling and referencing multiple inventories, we found the need to maintain the stocks of the produce in a proper management
                </li>
                <li className="m-4">
                  The ways to implement Inlumin into the daily schedule of the warehouses.
                </li>
                <li className="m-4">
                  The process of procurement and till the payment,it is observed that it is something which is delayed on multiple occasions. 
                </li>
                <li className="m-4">
