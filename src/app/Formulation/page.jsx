      ...
      <div className="bg-white">
        ...
        <main className="flex flex-col items-center justify-between mb-[10em]">
          ...
          <article className="ml-[13rem] ">
            <section id="question">
              <div className="font-semibold mb-4 h-[35vh] gap-[3em] shadow-xl flex flex-row items-center justify-start pl-10 bg-gradient-to-r from-green-700 via-green-300 to-slate-700">
            ...
            <section id="approach">
              ...
              <div className="text-4xl mt-10">
                ...
                <Image
                  src={all}
                  alt="img"
                  className="ml-[10em] lg:w-[20em] lg:h-[20em] md:size-[15em] sm:size[5em]"
                />
                <ul className="mt-10 flex flex-col gap-2">
                    ...
                    <div className="mt-3 font-normal w-4/5 items-center grid grid-cols-4">
                      <div>
                        <Image
                          src={img1}
                          alt="img"
                          className="w-[20em] h-[20em] object-contain lg:w-[20em] lg:h-[20em] md:size-[10em] "
                        />
                      </div>
                      <div className="col-span-3 ml-20 text-2xl ">
                        In this step, a tracker is being Developed to
                        systematically identify and resolve challenges within
                        the services area. Additionally, specialised training
                        sessions are being organised for a selected team members
                        to equip them with the necessary skills.I knowledge to
                        use the tracker efficiently.And handle service related
                        issues proactively.
                      </div>
                    </div>
                  </li>
                  <li className="font-semibold ">
                    ...
                    <div className="mt-3 font-normal w-4/5 items-center grid grid-cols-4">
                      <div className="col-span-3 text-2xl">
                        ...
                        identify and prioritise opportunities for quick
                        wins.This initiative encourages collaborative problem
                        solving and strategic alignment to drive impactful
                        results.
                      </div>
                      <div>
                        <Image
                          src={img2}
                          alt="img"
                          className="w-[20em] h-[20em] object-contain"
                        />
                      </div>
                    </div>
                  </li>
                  <li className="font-semibold ">
                    ...
                    <div className="mt-3 font-normal w-4/5 items-center grid grid-cols-4">
                      ...
                      <div className="col-span-3 ml-20 text-2xl ">
                        ...
                        detailing the road map for Implementation planning in
                        the selected zone. This report includes a well defined
                        pilot strategy to evaluate the feasibility and
                  ...
                  <li className="font-semibold ">
                    ...
                    <div className="mt-3 font-normal w-4/5 items-center grid grid-cols-4">
                      <div className="col-span-3 text-2xl">
                        ...
                        checklist. Each issue is assigned targets to specific
                        team members ensuring accountability and time
                        resolution.
                      </div>
                      <div>
                        <Image
                  ...
                  <li className="font-semibold ">
                    ...
                    <div className="mt-3 font-normal w-4/5 items-center grid grid-cols-4">
                      ...
                      <div className="col-span-3 ml-20 text-2xl ">
                        5S champions have been appointed for each zone to
                        oversee the Implementation and progress. Adding to site
                        champions are nominated to evaluate and recognize the
                        best work achieved till date.
                      </div>
                    </div>
                  </li>
                  <li className="font-semibold ">
                    ...
                    <div className="mt-3 font-normal w-4/5 items-center grid grid-cols-4">
                      <div className="col-span-3 text-2xl">
                        A meeting is scheduled with the 5S champions from all
                        zone to offer guidance, support and monitor progress.
                        The session will include conducting a radar audit in
            ...
            <section id="outcome">
              ...
              <div className="w-4/5 text-2xl font-normal mb-10">
                ...
                indicated by the three classifications. This strategic
                transition is designed to streamline operations and improve
                efficiency within the organization. The focus is now on ensuring
                that the Product Approval ANDAS (Abbreviated New Drug
                Application) submitted by the their sites begins to come
                through. This will enable the team to fast-track product
                launches, aligning with the company’s growth objectives. The
                successful and timely approval of ANDAS submissions is expected
                to significantly accelerate the development and release of new
                products. In parallel, the preparedness of all zones for
                upcoming audits is being carefully monitored. It is crucial that
                each zone meets the necessary standards and operational
                requirements to ensure smooth and successful audit outcomes.This
                proactive approach helps minimize any potential delays or
                disruptions, ensuring compliance with regulatory guidelines.
              </div>
              <div className="flex flex-row justify-center mr-[20em]">
                <Image
                  src={plant2}
                  alt="img"
                  className="lg:w-[25em] lg:h-[20em]"
                />
              </div>
            </section>
