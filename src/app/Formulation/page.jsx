    ...
    <div>
      <header className="flex flex-col ">
        ...
        <section className="h-[50vh] relative">
          ...
          />
          <h1 className="text-7xl font-semibold italic  absolute bottom-20 left-10">
        ...
        <article className="ml-[13rem] ">
              ...
              <ul className="mt-10 flex flex-col gap-10">
                <li className="font-semibold ">
                  ...
                  <div className="mt-5 font-normal w-4/5 items-center grid grid-cols-4">
                    <div>
                      <Image src={img1} alt="img" className="size-[20em] " />
                    </div>
          ...
          <section id="outcome">
            ...
            <div className="w-4/5 text-2xl font-normal mb-10">
              An indusstry leading company in the pharmaceuticals has shifted
